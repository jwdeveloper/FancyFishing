...
import jw.external.jw_modules.simple_commands.utilites.SimpleCommandUtility;
...
public class SimpleCommandService implements CommandService {
    ...
    public List<Consumer<SimpleCommandEvent>> getEventsToInvoke(CommandSender sender, HashMap<AccessType, Consumer<SimpleCommandEvent>> events) {
        ...
        result.add(events.get(AccessType.COMMAND_SENDER));
        if (senderType != AccessType.COMMAND_SENDER) {
